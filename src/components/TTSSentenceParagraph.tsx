          ...
          return (
            <React.Fragment key={sIdx}>
              <span
                ...
                className="inline cursor-pointer select-text"
                title={isSentenceActive ? "Reading position (Click to re-target)" : "Click to start Read Aloud from here"}
              >
                {tokens.map((tok, tIdx) => {
        ...
        return (
          <React.Fragment key={sIdx}>
            <span
              ...
              onPointerDown={handlePointerDown}
              onPointerUp={handlePointerUp}
              className="inline hover:bg-black/5 dark:hover:bg-white/5 transition-colors cursor-pointer select-text"
              style={{
                paddingTop: '2px',
                paddingBottom: '2px',
                paddingLeft: '0',
              ...
              title="Click to start Read Aloud from here"
            >
              {sText}
            </span>
            {trailingSpace}
